...
- Use `Stanley Chima` as the display name.
- Use `@chima-stanley-chuku` as the visible username unless Stanley gives a new
  username. Store the URL in JSON metadata as
  `https://www.linkedin.com/in/chima-stanley-chuku/`; do not draw Markdown
