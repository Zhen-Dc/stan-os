...
- Cover headline should dominate about 60% of a 1080x1440 canvas.
...
- Use `chima-stanley-chukwu` as the visible name and `@chima-stanley-chukwu` as the visible username unless the user overrides it.
...
- On slides 2-9, start the first content section close under the title/subtitle and use whitespace for useful audience-facing modules.
